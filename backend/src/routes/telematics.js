...
router.put(
  '/vehicles/:id',
  [authenticate, requirePermission('vehicles', 'write'), enforceFleetContext],
  async (req, res) => {
    try {
      const { id } = req.params;
      const { fleet_id } = req.user;
...
// Engage kill switch
router.post(
  '/vehicles/:id/kill-switch/engage',
  [
    authenticate,
...
router.post(
  '/vehicles/:id/kill-switch/disengage',
  [
    authenticate,
    requirePermission('kill_switch', 'write'),
    enforceFleetContext,
...
router.get(
  '/vehicles/:id/kill-switch/events',
  authenticate,
  enforceFleetContext,
  async (req, res) => {
    try {
