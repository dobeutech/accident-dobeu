...
router.get('/metrics', async (req, res) => {
  const { getMetrics } = require('../middleware/performanceMonitoring'); // eslint-disable-line global-require
  const { getDatabaseStats } = require('../middleware/queryMonitoring'); // eslint-disable-line global-require
